...
@Entity
public class MaxMinVente {
	
	
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	private int idMaxMin;
	...
	public int getIdMaxMin() {
		return idMaxMin;
	}
	public void setIdMaxMin(int idMaxMin) {
	...
	public String toString() {
		return "MaxMinVente [idMaxMin=" + idMaxMin + ", maxSAR=" + maxSAR + ", minSAR=" + minSAR + ", maxCAD=" + maxCAD
				+ ", minCAD=" + minCAD + ", maxDKK=" + maxDKK + ", minDKK=" + minDKK + ", maxUSD=" + maxUSD
