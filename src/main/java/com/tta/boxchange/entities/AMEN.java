...
public class AMEN {
    ...
    public void display()
    {
        System.out.println("My AMEN: " + idAMEN + " "
	...
	public String toString() {
		return "AMEN [idAMEN=" + idAMEN + ", codeDevise=" + codeDevise + ", uniteDevise=" + uniteDevise
				+ ", achatdevise=" + achatdevise + ", ventedevise=" + ventedevise + ", datedevise=" + datedevise + "]";
	}

	public int getIdAMEN() {
		return idAMEN;
	}

	public void setIdAMEN(int idAMEN) {
		this.idAMEN = idAMEN;
	}
