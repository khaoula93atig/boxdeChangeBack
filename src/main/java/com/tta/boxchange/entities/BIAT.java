...
public class BIAT {
    ...
    public void display()
    {
        System.out.println("My BIAT: " + idBIAT + " "
	...
	public String toString() {
		return "BIAT [idBIAT=" + idBIAT + ", codeDevise=" + codeDevise + ", uniteDevise=" + uniteDevise
				+ ", achatdevise=" + achatdevise + ", ventedevise=" + ventedevise + ", datedevise=" + datedevise + "]";
	}

	public int getIdBIAT() {
		return idBIAT;
	}

	public void setIdBIAT(int idBIAT) {
		this.idBIAT = idBIAT;
	}
